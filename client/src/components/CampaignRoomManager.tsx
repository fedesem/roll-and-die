  ...
  return (
    ...
    >
      <WorkspacePane as="section" className="admin-pane">
        ...
        <WorkspacePaneBody className="admin-scroll-region" contentClassName="list-stack">
      ...
      {role === "dm" ? (
        <WorkspacePane as="section" className="admin-pane">
          ...
          <WorkspacePaneBody className="admin-scroll-region" contentClassName="stack-form compact text-sm">
